...
Pay attention to a bit of unusual volume activity in the days leading up to the day of the event. This suggests to me that there is something we can detect to draw our attention to future price moves, acting quickly. Additionally there is continued price action up to five days after the event as the volume erodes. The price continues up! This is just six randomly selected events in a sea of additional examples. I need to continue my analysis to make sure that these samples weren't collected by some anomaly. This is definitely a discovery that can assit in the "swing" trader's arsenal. Opportunity exists.
